...
class MediasController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AgImAgenceBundle:Medias')->findAll();

        return $this->render('AgImAgenceBundle:Medias:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('AgImAgenceBundle:Medias:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AgImAgenceBundle:Medias')->find($id);
        ...
        return $this->render('AgImAgenceBundle:Medias:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('AgImAgenceBundle:Medias:edit.html.twig', array(
            'entity'      => $entity,
