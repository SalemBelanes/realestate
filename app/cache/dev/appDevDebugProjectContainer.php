...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_59d4a8ed48eb17c0b49e73042450670d53f8941f4f3468686a4624009e6b60cd');
        ...
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => 'D:\\businessInvent\\realestate\\src\\AgIm\\AgenceBundle\\Entity')), 'AgIm\\AgenceBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('AgImAgenceBundle' => 'AgIm\\AgenceBundle\\Entity'));
        $e->setMetadataCacheImpl($a);
        $e->setQueryCacheImpl($b);
        $e->setResultCacheImpl($c);
        $e->setMetadataDriverImpl($d);
        $e->setProxyDir('D:/businessInvent/realestate/app/cache/dev/doctrine/orm/Proxies');
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings(array(0 => 'D:\\businessInvent\\realestate\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml'));
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'upload_dir' => '/uploads',
            'upload_annonce' => '/annonce_',
            'upload_medias' => '/medias',
